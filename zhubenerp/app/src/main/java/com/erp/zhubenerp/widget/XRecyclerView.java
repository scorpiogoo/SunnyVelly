...
/**
 * Created by gubin on 2017/12/30.
 */
...
public class XRecyclerView extends RecyclerView {
    ...
    public void noMoreLoading(String string) {
        isLoadingData = false;
        View footView = mFootViews.get(0);
        isnomore = true;
        if (footView instanceof LoadingMoreFooter) {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (getLayoutManager() == null) {
            throw new IllegalArgumentException("请先设置LayoutManager!");
        }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= layoutManager.getItemCount() -1
                    && layoutManager.getItemCount() > layoutManager.getChildCount() && !isnomore && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
                View footView = mFootViews.get(0);
                isLoadingData = true;
                if (footView instanceof LoadingMoreFooter) {
    ...
    public void setRefresh() {
        mHeaderViews.get(0).setVisibility(View.VISIBLE);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled) {
                    ...
                    if (mRefreshHeader.getVisiableHeight() > 0 && mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING) {
                        ...
                        Log.i("getVisiableHeight", "getRefreshHeader.getState() = " + mRefreshHeader.getState());
                        return false;
                    }
                }
                break;
    ...
    private final RecyclerView.AdapterDataObserver mDataObserver = new RecyclerView.AdapterDataObserver() {
        ...
        public void onChanged() {
            ...
            if (adapter != null && mEmptyView != null) {
                ...
                if (adapter.getItemCount() == emptyCount || adapter.getItemCount() == 2) {
    ...
    public static class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void setRefreshing(boolean refreshing) {
            if (refreshing && pullRefreshEnabled && mLoadingListener != null) {
                ...
                mHeaderViews.get(0).setVisibility(View.VISIBLE);
                mRefreshHeader.onMove(mHeaderViews.get(0).getHeight());
                mLoadingListener.onRefresh();
            }
        }
